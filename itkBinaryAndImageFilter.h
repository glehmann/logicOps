#ifndef __itkBinaryAndImageFilter_h
#define __itkBinaryAndImageFilter_h
...
/** \class BinaryAndImageFilter
 * \brief Implements the BinaryAnd logical operator pixel-wise between two images.
 *
...
public:
  BinaryAnd() {};
  ~BinaryAnd() {};
  bool operator!=( const BinaryAnd & ) const
    {
    return false;
    }
  bool operator==( const BinaryAnd & other ) const
    {
    return !(*this != other);
    }
...
class ITK_EXPORT BinaryAndImageFilter :
    public
BinaryFunctorImageFilter<TImage, TImage, TImage, 
  Functor::BinaryAnd< typename TImage::PixelType > >


{
public:
  /** Standard class typedefs. */
  typedef BinaryAndImageFilter  Self;
  typedef BinaryFunctorImageFilter<TImage, TImage,TImage, 
    Functor::BinaryAnd<  typename TImage::PixelType> > Superclass;
...
private:
  BinaryAndImageFilter(const Self&); //purposely not implemented
